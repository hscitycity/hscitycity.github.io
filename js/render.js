...
async function renderMenu() {
  /*
    헤더 재설계(2026-07-25): 메뉴는 index.html의 정적 헤더로 이동했고,
    현재 페이지 표시·검색 토글·스티키 축소는 js/header.js가 담당한다.
    라우팅/데이터 로직은 그대로 재사용(renderBlogList/renderOtherContents/search).
    initialize()가 이 함수를 호출하므로 시그니처만 유지한다.
  */
}
